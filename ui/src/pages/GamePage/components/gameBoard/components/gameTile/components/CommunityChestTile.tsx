export const CommunityChestTile = () => {
    return (
        <div className='bg-[orange] flex items-center justify-center h-full text-center w-full shadow-lg border border-totorodarkgreen rounded-[5px]'>
